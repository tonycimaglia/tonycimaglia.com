...
how a class is used by another class

benefits
behavior from multiple source (can't inherit multiple classes in C#) must use an
interface for a struct as well (can't inherit from classes / other structs) I
convention
